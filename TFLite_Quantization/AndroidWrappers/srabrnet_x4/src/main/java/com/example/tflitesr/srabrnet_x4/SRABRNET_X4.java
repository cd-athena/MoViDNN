...
package com.example.tflitesr.srabrnet_x4;
...
/** Wrapper class of model srabrnet_x4 Model for SR-ABR (Version: unknown) */
public class SRABRNET_X4 {
  private final Metadata metadata;
  private final Model model;
  private static final String MODEL_NAME = "srabrnet_x4.tflite";
  private ImageProcessor lrImagePreprocessor;
  private ImageProcessor srImagePostprocessor;

  /** Output wrapper of {@link SRABRNET_X4} */
  ...
  /** Metadata accessors of {@link SRABRNET_X4} */
   ...
   */
  public static SRABRNET_X4 newInstance(Context context) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static SRABRNET_X4 newInstance(Context context, String modelPath) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static SRABRNET_X4 newInstance(Context context, Model.Options runningOptions) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static SRABRNET_X4 newInstance(Context context, String modelPath, Model.Options runningOptions) throws IOException {
    Model model = Model.createModel(context, modelPath, runningOptions);
    Metadata metadata = new Metadata(model.getData(), model);
    SRABRNET_X4 instance = new SRABRNET_X4(model, metadata);
  ...
  private SRABRNET_X4(Model model, Metadata metadata) {
    this.model = model;
