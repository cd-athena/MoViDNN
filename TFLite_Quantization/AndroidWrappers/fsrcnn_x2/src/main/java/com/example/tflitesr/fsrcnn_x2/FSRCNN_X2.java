...
package com.example.tflitesr.fsrcnn_x2;
...
/** Wrapper class of model FSRCNN X2 Model for SR-ABR (Version: unknown) */
public class FSRCNN_X2 {
  private final Metadata metadata;
  private final Model model;
  private static final String MODEL_NAME = "fsrcnn_x2.tflite";
  private ImageProcessor lrImagePreprocessor;
  private ImageProcessor srImagePostprocessor;

  /** Output wrapper of {@link FSRCNN_X2} */
  ...
  /** Metadata accessors of {@link FSRCNN_X2} */
   ...
   */
  public static FSRCNN_X2 newInstance(Context context) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static FSRCNN_X2 newInstance(Context context, String modelPath) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static FSRCNN_X2 newInstance(Context context, Model.Options runningOptions) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static FSRCNN_X2 newInstance(Context context, String modelPath, Model.Options runningOptions) throws IOException {
    Model model = Model.createModel(context, modelPath, runningOptions);
    Metadata metadata = new Metadata(model.getData(), model);
    FSRCNN_X2 instance = new FSRCNN_X2(model, metadata);
  ...
  private FSRCNN_X2(Model model, Metadata metadata) {
    this.model = model;
