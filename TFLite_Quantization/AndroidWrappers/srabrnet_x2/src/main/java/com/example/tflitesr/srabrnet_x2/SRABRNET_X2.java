...
package com.example.tflitesr.srabrnet_x2;
...
/** Wrapper class of model srabrnet_x2 Model for SR-ABR (Version: unknown) */
public class SRABRNET_X2 {
  private final Metadata metadata;
  private final Model model;
  private static final String MODEL_NAME = "srabrnet_x2.tflite";
  private ImageProcessor lrImagePreprocessor;
  private ImageProcessor srImagePostprocessor;

  /** Output wrapper of {@link SRABRNET_X2} */
  ...
  /** Metadata accessors of {@link SRABRNET_X2} */
   ...
   */
  public static SRABRNET_X2 newInstance(Context context) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static SRABRNET_X2 newInstance(Context context, String modelPath) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static SRABRNET_X2 newInstance(Context context, Model.Options runningOptions) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static SRABRNET_X2 newInstance(Context context, String modelPath, Model.Options runningOptions) throws IOException {
    Model model = Model.createModel(context, modelPath, runningOptions);
    Metadata metadata = new Metadata(model.getData(), model);
    SRABRNET_X2 instance = new SRABRNET_X2(model, metadata);
  ...
  private SRABRNET_X2(Model model, Metadata metadata) {
    this.model = model;
