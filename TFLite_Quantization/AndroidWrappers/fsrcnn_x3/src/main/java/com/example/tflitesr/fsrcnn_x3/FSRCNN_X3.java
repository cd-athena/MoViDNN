...
package com.example.tflitesr.fsrcnn_x3;
...
/** Wrapper class of model FSRCNN X3 Model for SR-ABR (Version: unknown) */
public class FSRCNN_X3 {
  private final Metadata metadata;
  private final Model model;
  private static final String MODEL_NAME = "fsrcnn_x3.tflite";
  private ImageProcessor lrImagePreprocessor;
  private ImageProcessor srImagePostprocessor;

  /** Output wrapper of {@link FSRCNN_X3} */
  ...
  /** Metadata accessors of {@link FSRCNN_X3} */
   ...
   */
  public static FSRCNN_X3 newInstance(Context context) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static FSRCNN_X3 newInstance(Context context, String modelPath) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static FSRCNN_X3 newInstance(Context context, Model.Options runningOptions) throws IOException {
   ...
   * @throws IOException if an I/O error occurs when loading the tflite model.
   */
  public static FSRCNN_X3 newInstance(Context context, String modelPath, Model.Options runningOptions) throws IOException {
    Model model = Model.createModel(context, modelPath, runningOptions);
    Metadata metadata = new Metadata(model.getData(), model);
    FSRCNN_X3 instance = new FSRCNN_X3(model, metadata);
  ...
  private FSRCNN_X3(Model model, Metadata metadata) {
    this.model = model;
