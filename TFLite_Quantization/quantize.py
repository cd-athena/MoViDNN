...
SAVED_MODEL = "./Checkpoints/EVSRNet_x4"
MODEL_NAME = "evsrnet_x4.tflite"
...
def float_quantize(scale_factor, model_name):
    def representative_dataset_gen():
        div2k = DIV2K(DATA_PATH, scale_factor=scale_factor, patch_size=0)
        for i in range(5):
            x, _ = div2k[i]
...
# float_quantize(scale_factor=SCALE, model_name=MODEL_NAME)
